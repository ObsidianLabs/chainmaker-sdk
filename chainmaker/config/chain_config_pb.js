 ...
 * @const
 */
proto.config.ChainConfig.repeatedFields_ = [9,10];
...
proto.config.ChainConfig.prototype.getResourcePoliciesList = function() {
  return /** @type{!Array<!proto.config.ResourcePolicy>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.config.ResourcePolicy, 10));
};
...
proto.config.ChainConfig.prototype.addResourcePolicies = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 10, opt_value, proto.config.ResourcePolicy, opt_index);
};
...
/**
 * optional ContractConfig contract = 11;
...
proto.config.ChainConfig.prototype.getContract = function() {
  return /** @type{?proto.config.ContractConfig} */ (
    jspb.Message.getWrapperField(this, proto.config.ContractConfig, 11));
};
...
/**
 * optional SnapshotConfig snapshot = 12;
...
proto.config.ChainConfig.prototype.getSnapshot = function() {
  return /** @type{?proto.config.SnapshotConfig} */ (
    jspb.Message.getWrapperField(this, proto.config.SnapshotConfig, 12));
};
...
/**
 * optional SchedulerConfig scheduler = 13;
...
proto.config.ChainConfig.prototype.getScheduler = function() {
  return /** @type{?proto.config.SchedulerConfig} */ (
    jspb.Message.getWrapperField(this, proto.config.SchedulerConfig, 13));
};
...
/**
 * optional ContextConfig context = 14;
...
proto.config.ChainConfig.prototype.getContext = function() {
  return /** @type{?proto.config.ContextConfig} */ (
    jspb.Message.getWrapperField(this, proto.config.ContextConfig, 14));
};
 ...
 * @return {string}
 */
proto.config.TrustRootConfig.prototype.getRoot = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.config.TrustRootConfig} returns this
 */
proto.config.TrustRootConfig.prototype.setRoot = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
