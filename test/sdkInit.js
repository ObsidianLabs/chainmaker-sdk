...
const userKeyPathFile2 = path.join(__dirname, './testFile/crypto-config/wx-org2.chainmaker.org/user/admin1/admin1.sign.key');
const userCertPathFile2 = path.join(__dirname, './testFile/crypto-config/wx-org2.chainmaker.org/user/admin1/admin1.sign.crt');
const orgID3 = 'wx-org3.chainmaker.org';
const userKeyPathFile3 = path.join(__dirname, './testFile/crypto-config/wx-org3.chainmaker.org/user/admin1/admin1.sign.key');
const userCertPathFile3 = path.join(__dirname, './testFile/crypto-config/wx-org3.chainmaker.org/user/admin1/admin1.sign.crt');
const orgID4 = 'wx-org4.chainmaker.org';
const userKeyPathFile4 = path.join(__dirname, './testFile/crypto-config/wx-org4.chainmaker.org/user/admin1/admin1.sign.key');
const userCertPathFile4 = path.join(__dirname, './testFile/crypto-config/wx-org4.chainmaker.org/user/admin1/admin1.sign.crt');
const orgID5 = 'wx-org5.chainmaker.org';
const userKeyPathFile5 = path.join(__dirname, './testFile/wx-org5.chainmaker.org/user/admin1/admin1.sign.key');
const userCertPathFile5 = path.join(__dirname, './testFile/wx-org5.chainmaker.org/user/admin1/admin1.sign.crt');
